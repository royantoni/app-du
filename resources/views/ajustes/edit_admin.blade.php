<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl ">
            ...
            <form method="POST" action="{{ route('admin.ajuste.datos.update', $user) }}">
                @method('PUT')
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        <label for="prefijo"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Prefijo</label>
                        <input type="text" name="prefijo" id="prefijo" value="{{ old('prefijo', $user->prefijo)  }}"
