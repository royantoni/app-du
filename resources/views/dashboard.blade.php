    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <a href="{{ route('admin.ajustes.datos_admin', auth()->user()->id) }}"
                ...
                role="alert">
                <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3">{{ auth()->user()->name }} {{ auth()->user()->lastname }}</span> <span
...
<div class="w-full   rounded-lg shadow flex justify-center">
    <img class="p-8 rounded-full " src="https://defensoria.unamba.edu.pe/assets/images/logo-du-unamba.png" alt="product image" />
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                Bienvenidos al sistema de administrador de quejas por parte de los integrantes de la Universidad.</p>
