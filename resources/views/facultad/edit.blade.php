<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center ">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Aqui puede
                editar el nombre de la facultad</p>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl ">
            ...
            <form method="POST" action="{{ route('admin.facultades.update', $facultade) }}">
                @method('PUT')
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nombre" id="name" value="{{ $facultade->nombre }}"
