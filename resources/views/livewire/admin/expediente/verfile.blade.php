    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center ">
            ...
            <h1
                ...
                Expediente {{ $numero_expediente }}</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">ver documentos sobre el expediente</p>
    ...
    <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <p>Dicho de la descripcion anterior la queja esta dirigido al Sr(a) <strong>{{ $quejado }}</strong>
                    con cargo de <strong>{{ $cargo }}</strong> en la oficina de
                    <strong>{{ $oficina }}</strong>, para ello adjunto mis documentos que indican las pruebas de
                    los echos incluyendo mi solicitud realizada a través de la plataforma.
                </p>

                <figure class="">
                    <div class="w-full  flex justify-center">
                        <img class="flex justify-center w-1/2 " src="{{ asset('logo/baner_du.svg') }}" alt="">
                    </div>
