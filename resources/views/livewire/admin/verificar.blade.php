                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="">
                                ...
                                <label for="default-radio-1"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Aceptado</label>
                            </div>
                            <div class="">
                                ...
                                <label for="default-radio-2"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Observado</label>
                            </div>
