            ...
            <section class="bg-white dark:bg-gray-900">
                <div class=" px-4 mx-auto max-w-screen-xl  lg:px-6 ">
                    <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 ">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Actualizar
                            Denuncia
                        </h2>
                        ...
                        <div class="w-full">
                            ...
                            <select id="facultade_id" wire:model.live="facultade_id"
                                ...
                                @foreach ($facultades as $item)                                    
                                    <option value="{{ $item->id }}" {{ $facultade_id == $item->id ? 'selected' : '' }}>{{ $item->nombre }}</option>
                                @endforeach
                            </select>
                            <div>
                                @error('email')
    ...
    @push('js')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                Livewire.on('denuncia_actualizada', () => {
                    Swal.fire({
                        position: "top-end",
                        icon: "success",
                        ...
                        window.location.href = "{{ route('persona.lista') }}";
                    });
                });
