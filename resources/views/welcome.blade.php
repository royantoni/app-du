                    ...
                    <div class="">
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Panel</a>
                        @else
                            <a href="{{ route('login') }}"
                ...
                <ul
                    ...
                    <li>
                        <a href="https://www.unamba.edu.pe/" target="_blank"
                            ...
                            aria-current="page">Universidad</a>
                    </li>
                    <li>
                        <a href="https://defensoria.unamba.edu.pe/" target="_blank"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Defensoría</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1
                    ...
                    Defensoria Universitaria</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                    Bienvenido al modulo de quejas, realice sus peticiones aquí, estaremos pendiente de sus solicitudes
